"""Module for cleaning up deployed resources.
...
Functions:
    ...
    cleanup: Main command-line interface function for cleaning up resources.
"""
...
def choose_resource(resource_type: str, sagemaker_client: Any) -> str:
    """Choose a specific resource for cleanup.
...
@click.command(help="Remove deployed models and endpoints from the cloud.")
def cleanup() -> None:
    """Command-line interface for cleaning up resources.

    This function is the entry point for the CLI to remove deployed models
    and endpoints. It loads credentials, asks the user what they'd like to clean up,
